...
# -*- coding: utf-8 -*-
#
# pyamgx documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pyamgx.tex', 'pyamgx Documentation',
...
man_pages = [
    (master_doc, 'pyamgx', 'pyamgx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyamgx', 'pyamgx Documentation',
     author, 'pyamgx', 'One line description of project.',
     'Miscellaneous'),
]
